...
4. The fundamental of modern web development is all about how to **sotring**, **delivering** and **presenting** information. Websites are evnetually collections of documents that present information to their users, those informations are stored in some computer, and delivered to the users through internet.
